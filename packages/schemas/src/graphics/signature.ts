import type { Plugin, Schema } from '@weberon/common';
import { ZOOM } from '@weberon/common';
  ...
  ui: async (arg) => {
    ...
    if (context) {
      ...
      try {
        ...
        signaturePad.clear();
        showLoadError();
        console.error('[@weberon/schemas] Failed to restore saved signature data.', error);
      }
